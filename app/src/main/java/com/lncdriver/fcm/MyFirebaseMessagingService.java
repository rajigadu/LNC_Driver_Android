...
import com.lncdriver.activity.Splash;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (remoteMessage.getData().get("data") != null &&
                    !Objects.requireNonNull(remoteMessage.getData().get("data")).equalsIgnoreCase("")) {
                try {
                    ...
                    if (jarray != null) {
                        Global.mapMain = Utils.GetJsonDataIntoMap(getApplicationContext(), jarray, "");
                    }
                    ...
                    if(!userid.equals("")){
                        sendNotification(title, Global.mapMain);
                    }
