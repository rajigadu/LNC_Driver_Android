        ...
        protected void onPreExecute() {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    locationAA = mLocationManager.getLastKnownLocation(mLocationManager.GPS_PROVIDER);
                    mLocationManager.requestLocationUpdates(mLocationManager.GPS_PROVIDER, 50000, 0, mVeggsterLocationListener);

                    if(locationAA == null){
                        locationAA = mLocationManager.getLastKnownLocation(mLocationManager.NETWORK_PROVIDER);
                        mLocationManager.requestLocationUpdates(mLocationManager.NETWORK_PROVIDER, 50000, 0, mVeggsterLocationListener);
                    }
                }
            }else{
                mVeggsterLocationListener = new VeggsterLocationListener();
