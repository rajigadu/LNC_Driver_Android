...
public class DFutureRideHistoryAdapter extends RecyclerView.Adapter
{
   ...
   public DFutureRideHistoryAdapter(Context context, List<ModelItem> students, RecyclerView recyclerView, int layout, int mode)
   {
   ...
   public static class InboxViewHolder extends RecyclerView.ViewHolder
   {
       ...
       public TextView date,stops,ride,distance;
