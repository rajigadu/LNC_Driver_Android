...
//                            Utils.toastTxt(""+msg, mcontext);
    ...
    public static void MyrequestsListRequest() {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_PARTNERINCOMINGFUTURERIDE);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.PartnerIncomingFutureRides);
        } else {
    ...
    public void acceptFutureRideRequest(String rid) {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_PARTNERACCEPTFUTURERIDE);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.PartnerAcceptFutureRide);
        } else {
            Utils.showInternetErrorMessage(mcontext);
        }
    }
