...
public class PendingCurrentRides extends Fragment
{
    ...
    public static  void MyrequestsListRequest()
    {
        ...
        Utils.global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_PENDINGCURRENTRIDES);

        if(Utils.isNetworkAvailable(mcontext))
        {
            JsonPost.getNetworkResponse(mcontext,null,Utils.global.mapMain,ConstVariable.Pending_Current_Rides);
        }
        else
        {
