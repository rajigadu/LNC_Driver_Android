...
import com.lncdriver.adapter.DFutureRideHistoryAdapter;
...
public class DFutureRideHistory extends Fragment {
    static RecyclerView rv_loc;

    public static Context mcontext;
    public static DFutureRideHistoryAdapter requestsAdapter;
    ...
    public void onViewCreated(View v, @Nullable Bundle savedInstanceState) {
        ...
        requestsListMan = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
    ...
    public static void MyrequestsListRequest() {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_FUTURE_RIDE_HISTORY);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.FutureRideHistory);
        } else {
    ...
    public static void setAdapterFriendsRequestList(final Context context) {
        ...
        requestsAdapter = new DFutureRideHistoryAdapter(mcontext, requestsList, rv_loc, R.layout.cride_rowitem, ConstVariable.Login);
