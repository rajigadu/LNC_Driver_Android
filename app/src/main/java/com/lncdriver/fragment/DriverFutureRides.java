...
public class DriverFutureRides extends Fragment {
    ...
    public static void MyrequestsListRequest() {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_DRIVERFUTURERIDES);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.DriverFutureRides);
        } else {
