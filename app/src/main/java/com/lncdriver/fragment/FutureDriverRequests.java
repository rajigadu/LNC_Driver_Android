...
//        MyrequestsListRequest();
    ...
    public static void MyrequestsListRequest() {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_DRIVERINCOMINGFUTURERIDE);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.DriverIncomingFutureRides);
        } else {
...
//    }
    ...
    public void acceptFutureRideRequest(String rid) {
        ...
        rideId = rid;
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_DRIVERACCEPTFUTURERIDE);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.DriverAcceptFutureRide);
        } else {
            Utils.showInternetErrorMessage(mcontext);
        }
    }
