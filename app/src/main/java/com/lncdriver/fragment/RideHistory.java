...
import com.lncdriver.adapter.RideHistoryAdapter;
...
public class RideHistory extends Fragment {
    ...
    public static void MyrequestsListRequest() {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_RIDEHISTORY);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.RideHistory);
        } else {
    ...
    public static void setAdapterFriendsRequestList(final Context context) {
        ...
        requestsAdapter = new RideHistoryAdapter(mcontext, requestsList, rv_loc, R.layout.cride_rowitem_2,
                ConstVariable.Login);
