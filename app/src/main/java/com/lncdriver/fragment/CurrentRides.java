...
public class CurrentRides extends Fragment
{
    ...
    public static  void MyrequestsListRequest()
    {
        ...
        Utils.global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_CURRENTRIDES);

        if(Utils.isNetworkAvailable(mcontext))
        {
            JsonPost.getNetworkResponse(mcontext,null,Utils.global.mapMain,ConstVariable.CurrentRide);
        }
        else
        {
