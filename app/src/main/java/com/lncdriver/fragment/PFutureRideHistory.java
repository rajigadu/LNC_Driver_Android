...
import com.lncdriver.adapter.PFutureRideHistoryAdapter;
...
public class PFutureRideHistory extends Fragment
{
    static RecyclerView rv_loc;

    public static Context mcontext;
    public static PFutureRideHistoryAdapter requestsAdapter;
    ...
    public static  void MyrequestsListRequest()
    {
        ...
        Utils.global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_PARTNERFUTURERIDEHISTORY);

        if(Utils.isNetworkAvailable(mcontext))
        {
            JsonPost.getNetworkResponse(mcontext,null,Utils.global.mapMain,ConstVariable.PartnerFutureRideHistory);
        }
        else
        {
    ...
    public static void setAdapterFriendsRequestList(final Context context)
    {
        ...
        requestsAdapter = new PFutureRideHistoryAdapter(mcontext,requestsList,rv_loc,R.layout.cride_rowitem,ConstVariable.Login);
