...
public class PFutureRideHistory extends Fragment
{
    ...
    public static  void MyrequestsListRequest()
    {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_PARTNERFUTURERIDEHISTORY);

        if(Utils.isNetworkAvailable(mcontext))
        {
            JsonPost.getNetworkResponse(mcontext,null, Global.mapMain,ConstVariable.PartnerFutureRideHistory);
        }
        else
        {
