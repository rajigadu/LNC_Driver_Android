...
public class PaymentListHistory extends Fragment {
    ...
    public void MyRequestsListRequest() {
        ...
        Global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_PAYMENTHISTORY);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.New_Payment_History);
        } else {
