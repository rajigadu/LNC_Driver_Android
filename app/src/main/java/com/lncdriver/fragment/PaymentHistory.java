...
public class PaymentHistory extends Fragment {
    ...
    public void MyRequestsListRequest() {
        ...
        Utils.global.mapMain.put("from_week", week.getFromDate());
        Utils.global.mapMain.put("to_week", week.getToDate());
        Utils.global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_WEEK_REPORT);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Utils.global.mapMain, ConstVariable.Payment_History);
        } else {
