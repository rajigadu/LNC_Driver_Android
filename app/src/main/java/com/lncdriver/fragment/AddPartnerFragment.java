...
public class AddPartnerFragment extends Fragment implements View.OnClickListener {
    ...
    private void postDummyPartner() {
        ...
        Global.mapMain.put("dummy_id", partDummyId);
        Global.mapMain.put(ConstVariable.DRIVER_ID, driverId);

        ServiceApiGet service = ServiceGenerator.createService(ServiceApiGet.class);
        Call<ResponseBody> response = service.login(Settings.URL_DUMMY_PARTNER_FUTURE_ACCEPT, Global.mapMain);
