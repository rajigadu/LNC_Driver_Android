...
public class ViewPaymentDetailsInfo extends AppCompatActivity implements View.OnClickListener {
    ...
    public void populatePaymentData() {
        ...
        if (customerName != null && !customerName.toString().equalsIgnoreCase("")) {
            String s = "", e = "";
            s = getColoredSpanned("Customer Name : ", "#8000000");
            e = getColoredSpanned(customerName.toString(), "#99000000");
            tvCustomerName.setText(Html.fromHtml(s + e));
        } else {
            tvCustomerName.setVisibility(View.GONE);
        }

        if (pickUpAddress != null && !pickUpAddress.toString().equalsIgnoreCase("")) {
            String s = "", e = "";
            s = getColoredSpanned("Pick Up : ", "#8000000");
            e = getColoredSpanned(pickUpAddress.toString(), "#99000000");
            tvPickUp.setText(Html.fromHtml(s + e));
        } else {
            tvPickUp.setVisibility(View.GONE);
        }

        if (transactionId != null && !transactionId.toString().equalsIgnoreCase("")) {
            String s = "", e = "";
            s = getColoredSpanned("Transaction Id : ", "#8000000");
            e = getColoredSpanned(transactionId.toString(), "#99000000");
            tvTransactionId.setText(Html.fromHtml(s + e));
        } else {
            tvTransactionId.setVisibility(View.GONE);
        }

        if (dropAddress != null && !dropAddress.toString().equalsIgnoreCase("")) {
            String s = "", e = "";
            s = getColoredSpanned("Drop Off : ", "#8000000");
            e = getColoredSpanned(dropAddress.toString(), "#99000000");
        ...
        if (partnerName != null && !partnerName.trim().equalsIgnoreCase("")) {
            ...
            e = getColoredSpanned(partnerName.toString(), "#99000000");
        ...
        if (partnerEmail != null && !partnerEmail.toString().equalsIgnoreCase("")) {
            ...
            e = getColoredSpanned(partnerEmail.toString(), "#99000000");
        ...
        if (partnerPhone != null && !partnerPhone.toString().equalsIgnoreCase("")) {
            ...
            e = getColoredSpanned(partnerPhone.toString(), "#99000000");
