...
public class Navigation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!urat.toString().equalsIgnoreCase("")) {
            rating.setText(urat);
        }
...
//                }
    ...
    public void logoutRequest() {
        ...
        Utils.global.mapMain.put("type", "logout");
        Utils.global.mapMain.put("status", "2");
        Utils.global.mapMain.put("version", "yes");
        Utils.global.mapMain.put(ConstVariable.URL, com.lncdriver.utils.Settings.URL_DRIVER_ONLINE_REQUEST);

        if (Utils.isNetworkAvailable(Navigation.this)) {
            JsonPost.getNetworkResponse(Navigation.this, null, Utils.global.mapMain, ConstVariable.Log_Out);
        } else {
