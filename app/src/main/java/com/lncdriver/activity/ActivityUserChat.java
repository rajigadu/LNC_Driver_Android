...
//        }
        ...
        Utils.global.mapMain.put("keyvalue", "driver");
        Utils.global.mapMain.put(ConstVariable.URL, Settings.URL_USERCHAT);

        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Utils.global.mapMain, ConstVariable.UserChatList);
        } else {
...
//            did = pref1.getCustomerId();
        ...
        if (message.getText().toString().trim().isEmpty()) {
            ...
            if (Utils.isNetworkAvailable(ActivityUserChat.this)) {
                message.setText("");
                JsonPost.getNetworkResponse(ActivityUserChat.this, null, Utils.global.mapMain, ConstVariable.UserChat);
            } else {
