...
public class ActivityPartnerChat extends AppCompatActivity {
    ...
    public static void chatListRequest() {
        ...
        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Utils.global.mapMain, ConstVariable.PartnerChatList);
        } else {
    ...
    public void submit() {
        ...
        if (message.getText().toString().trim().isEmpty()) {
            ...
            if (Utils.isNetworkAvailable(ActivityPartnerChat.this)) {
                message.setText("");
                JsonPost.getNetworkResponse(ActivityPartnerChat.this, null, Utils.global.mapMain, ConstVariable.PartnerChat);
            } else {
