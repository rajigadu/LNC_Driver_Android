...
public class ViewRideMap extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            if (map.containsKey("pickup_lat") && !map.get("pickup_lat").toString().equalsIgnoreCase("")) {
                ...
                options.title(map.get("pickup_address").toString());
                m1 = mGoogleMap.addMarker(options);
                m1.showInfoWindow();
            }
            ...
            if (map.containsKey("d_lat") && !map.get("d_lat").toString().equalsIgnoreCase("")) {
                ...
                options.title(map.get("drop_address").toString());
                m2 = mGoogleMap.addMarker(options);
                m2.showInfoWindow();

                LatLng origin = new LatLng(Double.valueOf(map.get("pickup_lat").toString()), Double.valueOf(map.get("pickup_long").toString()));
                LatLng dest = new LatLng(Double.valueOf(map.get("d_lat").toString()), Double.valueOf(map.get("d_long").toString()));
    ...
    private String getUrl(LatLng origin, LatLng dest) {
        ...
        String parameters = str_origin + "&" + str_dest + "&" + "key=" + ConstVariable.GOOGLE_API + "&" + sensor;
