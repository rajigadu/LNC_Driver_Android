...
public class ActivityDriverChat extends AppCompatActivity {
    ...
    private final boolean isNotifClick = false;
...
//        }
    ...
    public static void chatListRequest() {
        ...
        if (Utils.isNetworkAvailable(mcontext)) {
            JsonPost.getNetworkResponse(mcontext, null, Global.mapMain, ConstVariable.DriverChatList);
        } else {
    ...
    public void submit() {
        ...
        if (message.getText().toString().trim().isEmpty()) {
            ...
            if (Utils.isNetworkAvailable(ActivityDriverChat.this)) {
                message.setText("");
                JsonPost.getNetworkResponse(ActivityDriverChat.this, null, Global.mapMain, ConstVariable.DriverChat);
            } else {
