            ...
            if(status.equalsIgnoreCase("1")){
                ...
                if(jsonArray.length() > 0){
                    for(int i = 0 ; i < jsonArray.length() ; i++){
                        ...
                        if (jsonObjectOuter.has("second") && !jsonObjectOuter.getString("second").toString().equalsIgnoreCase("")) {
                            int value = Integer.parseInt(jsonObjectOuter.getString("second").toString());
