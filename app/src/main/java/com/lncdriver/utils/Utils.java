...
public class Utils {
    ...
    // Image Loader end
    public static androidx.appcompat.app.AlertDialog cartdialog;
    ...
    public static void showCancelRideStatusDialog(String mtitle, String dlgText, Context mcontext) {
        ...
        final View dialogLayout = inflater.inflate(R.layout.alert_dialog1, null);
        final androidx.appcompat.app.AlertDialog dialog = new androidx.appcompat.app.AlertDialog.Builder(mcontext,
    ...
    public static void showRideRequestDialog(final Context mcontext) {
        ...
        cartdialog = new androidx.appcompat.app.AlertDialog.Builder(Utils.context).create();
                    ...
                    if (response.body() != null) {
                        ...
                        if (mode == ConstVariable.Login) {
                            ...
                            if (result.equalsIgnoreCase(ConstVariable.SUCCESS)) {
                                Utils.toastTxt(Global.mapMain.get(ConstVariable.MESSAGE).toString(), Utils.context);
                                Utils.startActivity(context, Login.class);
                            } else {
                                Utils.showOkDialog(result, context);
                            }
                        }
