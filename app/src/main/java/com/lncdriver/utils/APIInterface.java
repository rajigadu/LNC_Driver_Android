...
public interface APIInterface {
    ...
    Call<ResponseBody>
    getAcceptRide(
            @Query("driver_id") String devicetoken
    );
...
//            @Query("cvv") String cvv
  ...
  //  http://lnc.latenightchauffeurs.com/lnc-administrator/admin/handbook_api.php
...
//    Call<ResponseBody> advertiseWithUsVO(@Part ArrayList<MultipartBody.Part> hashMap);
    ...
    @Multipart
    @POST("ads_by_screen")
    Call<ResponseBody> adsByScreen(@Part ArrayList<MultipartBody.Part> hashMap);
...
//    Call<ResponseBody> activeJobs(@Part ArrayList<MultipartBody.Part> hashMap);
    ...
    @GET("driver_accepted_future_ride_list.php?")
    Call<ResponseBody> driver_accepted_future_ride_list(@Query("driver_id") String origins);

    @GET("partner_accepted_future_ride_list.php?")
    Call<ResponseBody> partner_accepted_future_ride_list(@Query("driver_id") String origins);

//    @Multipart
//    @POST("distancematrix/json?")
//    Call<ResponseBody> getEstimation(@Part ArrayList<MultipartBody.Part> hashMap);


//    @Multipart
//    @POST("distancematrix/json?units=imperial")
//    Call<ResponseBody> getEstimation(@Query("driverid") String devicetoken);

    @GET("distancematrix/json?")
    Call<ResponseBody> getEstimation(@Query("origins") String origins,
                                     @Query("destinations") String destinations,
                                     @Query("key") String key);


    @GET("swap-role.php?")
    Call<ResponseBody> swapDriver(@Query("ride_id") String ride_id,
                                     @Query("swap") String swap);

//    http://lnc.latenightchauffeurs.com/lnc-administrator/android/driver/swap-role.php?ride_id=10012&swap=1

    @GET("check-approved-status.php?")
    Call<ResponseBody> logDriver(@Query("driver_id") String driver_id);
